    ...
    <div class="topbar topbar-dark bg-dark" style="z-index:999">
      <div class="container d-md-flex align-items-center px-0 px-xl-3">
        ...
        <div class="d-flex text-md-end ms-md-auto">
          ...
          <div class="dropdown"><a class="topbar-link dropdown-toggle" href="#" data-bs-toggle="dropdown">₹ Rupees (INR)</a>
            <div class="dropdown-menu dropdown-menu-end">
              <a class="dropdown-item" href="#">₹ Rupees (INR)</a>
...
if ( $geoplugin->currency != $geoplugin->currencyCode ) {
	...
	echo "<p>At todays rate, INR 500 will cost you " . $geoplugin->convert(500) ." </p>\n";
}
