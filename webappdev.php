...
<meta name="description" content="Codewills provide web application development services in India such as single-page web apps, web portal apps, progressive web apps, Ecommerce web apps etc.">
          ...
          <div class="col-lg-7 col-md-7 order-md-2 overflow-hidden">
            <div class="parallax me-n7 me-md-0" style="max-width: 1030px;"><img class="d-block"
              ...
              <div class="parallax-layer" style="z-index: 2;" data-depth="0.13"><img
                  src="img/services/web-application-development-services-in-india.webp" alt="web-application-development-services-in-india"></div>
